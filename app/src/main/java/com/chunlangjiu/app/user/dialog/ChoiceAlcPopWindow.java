 ...
 * @Describe:
 */
public class ChoiceAlcPopWindow extends PopupWindow {
    ...
    private List<AlcListBean.AlcBean> brandLists;
    ...
    public ChoiceAlcPopWindow(Context context, List<AlcListBean.AlcBean> brands, String selectBrandId) {
        super(context);
    ...
    private void initView() {
        ...
        brandAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                selectBrandId = brandLists.get(position).getAlcohol_id();
                brandAdapter.notifyDataSetChanged();
                if (callBack != null) {
                    callBack.choiceBrand(brandLists.get(position).getAlcohol_name(), brandLists.get(position).getAlcohol_id());
                }
                dismiss();
            }
        });
    ...
    public void setBrandList(List<AlcListBean.AlcBean> brands,String selectBrandId) {
        this.brandLists = brands;
        this.selectBrandId = selectBrandId;
    ...
    public class BrandAdapter extends BaseQuickAdapter<AlcListBean.AlcBean, BaseViewHolder> {

        public BrandAdapter(int layoutResId, List<AlcListBean.AlcBean> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, AlcListBean.AlcBean item) {
            TextView tvName = helper.getView(R.id.tvName);
            tvName.setText(item.getAlcohol_name());
            if (item.getAlcohol_id().equals(selectBrandId)) {
