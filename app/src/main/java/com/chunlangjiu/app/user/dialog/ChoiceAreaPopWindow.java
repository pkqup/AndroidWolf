 ...
 * @Describe:
 */
public class ChoiceAreaPopWindow extends PopupWindow {
    ...
    private List<AreaListBean.AreaBean> brandLists;
    ...
    public ChoiceAreaPopWindow(Context context, List<AreaListBean.AreaBean> brands, String selectBrandId) {
        super(context);
    ...
    private void initView() {
        ...
        brandAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                selectBrandId = brandLists.get(position).getArea_id();
                brandAdapter.notifyDataSetChanged();
                if (callBack != null) {
                    callBack.choiceBrand(brandLists.get(position).getArea_name(), brandLists.get(position).getArea_id());
                }
                dismiss();
            }
        });
    ...
    public void setBrandList(List<AreaListBean.AreaBean> brands,String selectBrandId) {
        this.brandLists = brands;
        this.selectBrandId = selectBrandId;
    ...
    public class BrandAdapter extends BaseQuickAdapter<AreaListBean.AreaBean, BaseViewHolder> {

        public BrandAdapter(int layoutResId, List<AreaListBean.AreaBean> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, AreaListBean.AreaBean item) {
            TextView tvName = helper.getView(R.id.tvName);
            tvName.setText(item.getArea_name());
            if (item.getArea_id().equals(selectBrandId)) {
