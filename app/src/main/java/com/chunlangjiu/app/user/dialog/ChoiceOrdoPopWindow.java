 ...
 * @Describe:
 */
public class ChoiceOrdoPopWindow extends PopupWindow {
    ...
    private List<OrdoListBean.OrdoBean> brandLists;
    ...
    public ChoiceOrdoPopWindow(Context context, List<OrdoListBean.OrdoBean> brands, String selectBrandId) {
        super(context);
    ...
    private void initView() {
        ...
        brandAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                selectBrandId = brandLists.get(position).getOdor_id();
                brandAdapter.notifyDataSetChanged();
                if (callBack != null) {
                    callBack.choiceBrand(brandLists.get(position).getOdor_name(), brandLists.get(position).getOdor_id());
                }
                dismiss();
            }
        });
    ...
    public void setBrandList(List<OrdoListBean.OrdoBean> brands,String selectBrandId) {
        this.brandLists = brands;
        this.selectBrandId = selectBrandId;
    ...
    public class BrandAdapter extends BaseQuickAdapter<OrdoListBean.OrdoBean, BaseViewHolder> {

        public BrandAdapter(int layoutResId, List<OrdoListBean.OrdoBean> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, OrdoListBean.OrdoBean item) {
            TextView tvName = helper.getView(R.id.tvName);
            tvName.setText(item.getOdor_name());
            if (item.getOdor_id().equals(selectBrandId)) {
